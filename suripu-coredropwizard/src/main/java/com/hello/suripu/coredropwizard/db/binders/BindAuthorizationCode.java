...
@BindingAnnotation(BindAuthorizationCode.BindRegistrationFactory.class)
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.PARAMETER})
public @interface BindAuthorizationCode {

    public static class BindRegistrationFactory implements BinderFactory {
        public Binder build(Annotation annotation) {
            return new Binder<BindAuthorizationCode, AuthorizationCode>() {
                public void bind(SQLStatement q, BindAuthorizationCode bind, AuthorizationCode arg) {
