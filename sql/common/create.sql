...
CREATE TABLE sleep_scores (
    ...
    date_hour_utc TIMESTAMP, -- Y-m-d H:00 in UTC
    offset_millis INTEGER,
    ...
    total_hour_score INTEGER, -- hourly score, updated as we get more data
    sax_symbols VARCHAR (60),  -- sax-based score, one symbol per min or per 5 mins
