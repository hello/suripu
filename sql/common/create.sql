...
-- Added Feb 3rd, 2017
CREATE TABLE voice_command_topic (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE voice_command_subtopic (
    id SERIAL PRIMARY KEY,
    command_title VARCHAR(255) NOT NULL,
    voice_command_topic_id INTEGER references voice_command_topic(id) NOT NULL
);

CREATE TABLE voice_commands(
    id SERIAL PRIMARY KEY,
    command VARCHAR(255) NOT NULL,
    voice_command_subtopic_id INTEGER references voice_command_subtopic(id) NOT NULL
);



INSERT INTO voice_command_topic (title, description, icon) VALUES
...
INSERT INTO voice_command_subtopic(command_title, voice_command_topic_id) VALUES
    ('Alarms', (SELECT id FROM voice_command_topic where title = 'Alarm and Sleep Sounds')),
    ('Sleep Sounds', (SELECT id FROM voice_command_topic where title = 'Alarm and Sleep Sounds')),
    ('Sleep Timeline', (SELECT id FROM voice_command_topic where title = 'Sleep')),
    ('Temperature', (SELECT id FROM voice_command_topic where title = 'Room Conditions')),
    ('Humidity', (SELECT id FROM voice_command_topic where title = 'Room Conditions')),
    ('Noise Level', (SELECT id FROM voice_command_topic where title = 'Room Conditions')),
    ('Air Quality', (SELECT id FROM voice_command_topic where title = 'Room Conditions')),
    ('Lights', (SELECT id FROM voice_command_topic where title = 'Expansions')),
    ('Thermostat', (SELECT id FROM voice_command_topic where title = 'Expansions'));

INSERT INTO voice_commands(command, voice_command_subtopic_id) VALUES
    ('Wake me up at 10 AM.', (SELECT id FROM voice_command_subtopic where command_title = 'Alarms')),
    ('Set alarm for tomorrow morning at 8.', (SELECT id FROM voice_command_subtopic where command_title = 'Alarms')),
    ('Play a Sleep Sound.',  (SELECT id FROM voice_command_subtopic where command_title = 'Sleep Sounds')),
    ('Play White Noise.',  (SELECT id FROM voice_command_subtopic where command_title = 'Sleep Sounds')),
    ('How was my sleep last night?', (SELECT id FROM voice_command_subtopic where command_title = 'Sleep Timeline')),
    ('What was my Sleep Score?', (SELECT id FROM voice_command_subtopic where command_title = 'Sleep Timeline')),
    ('What is the temperature?', (SELECT id FROM voice_command_subtopic where command_title = 'Temperature')),
    ('What is the humidity?', (SELECT id FROM voice_command_subtopic where command_title = 'Humidity')),
    ('How noisy is it?', (SELECT id FROM voice_command_subtopic where command_title = 'Noise Level')),
    ('What is the noise level?', (SELECT id FROM voice_command_subtopic where command_title = 'Noise Level')),
    ('How is the air quality?', (SELECT id FROM voice_command_subtopic where command_title = 'Air Quality')),
    ('Turn the lights on.', (SELECT id FROM voice_command_subtopic where command_title = 'Lights')),
    ('Turn the lights off.', (SELECT id FROM voice_command_subtopic where command_title = 'Lights')),
    ('Brighten the lgihts.', (SELECT id FROM voice_command_subtopic where command_title = 'Lights')),
    ('Dim the lights.',  (SELECT id FROM voice_command_subtopic where command_title = 'Lights')),
    ('Set the thermostat to 70°.',  (SELECT id FROM voice_command_subtopic where command_title = 'Thermostat'));
