...
s3cmd put suripu-workers/configs/pill/pill_save_ddb.prod.yml s3://hello-deploy/configs/com/hello/suripu/suripu-workers/$VERSION/pill_save_ddb.prod.yml
...
s3cmd put suripu-workers/configs/pill/pill_save_ddb.staging.yml s3://hello-deploy/configs/com/hello/suripu/suripu-workers/$VERSION/pill_save_ddb.staging.yml
