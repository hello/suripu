...
public class InsightUtilsTest {
    ...
    public void testTimeConvert() {
        ...
        final String convertedTime = InsightUtils.timeConvert(minute, DateTimeFormat.forPattern("h:mm aa"));
    ...
    public void testTimeConvertRound3() {
        final int minute = 421;
        final String expectedTime = "7:00 AM";
        final String convertedTime = InsightUtils.timeConvertRound(minute, DateTimeFormat.forPattern("h:mm aa"));
        assertThat(expectedTime, is(convertedTime));
    }
    ...
    public void testTimeConvertRound7() {
        ...
        final String convertedTime = InsightUtils.timeConvertRound(minute, DateTimeFormat.forPattern("HH:mm"));
        assertThat(expectedTime, is(convertedTime));
    }
