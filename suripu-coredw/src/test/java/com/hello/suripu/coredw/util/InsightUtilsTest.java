...
public class InsightUtilsTest {
    ...
    public void testTimeConvert() {
        ...
        final String convertedTime = InsightUtils.timeConvert(minute, TimeFormat.TIME_TWELVE_HOUR);
    ...
    public void testTimeConvertRound3() {
        final int minute = 421;
        final String expectedTime = "7:00 AM";
        final String convertedTime = InsightUtils.timeConvertRound(minute, TimeFormat.TIME_TWELVE_HOUR);
        assertThat(expectedTime, is(convertedTime));
    }
    ...
    public void testTimeConvertRound7() {
        ...
        final String convertedTime = InsightUtils.timeConvertRound(minute, TimeFormat.TIME_TWENTY_FOUR_HOUR);
        assertThat(expectedTime, is(convertedTime));
    }
