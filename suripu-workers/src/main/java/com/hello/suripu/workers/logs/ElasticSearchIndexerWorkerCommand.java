...
public class ElasticSearchIndexerWorkerCommand extends ConfiguredCommand<LogIndexerWorkerConfiguration> {
    ...
    public ElasticSearchIndexerWorkerCommand(final String name, final String description) {
    ...
    protected void run(final Bootstrap<LogIndexerWorkerConfiguration> bootstrap, final Namespace namespace, final LogIndexerWorkerConfiguration configuration) throws Exception {
        ...
        final KinesisClientLibConfiguration kinesisConfig = new KinesisClientLibConfiguration(
                ...
                workerId);
        kinesisConfig.withMaxRecords(configuration.getElasticSearchConfiguration().getBulkActions());
        ...
        final IRecordProcessorFactory factory = new ElasticSearchIndexerProcessorFactory(configuration);
