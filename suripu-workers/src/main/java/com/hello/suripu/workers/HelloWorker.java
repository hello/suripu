...
import com.hello.suripu.workers.logs.ElasticSearchIndexerWorkerCommand;
...
public class HelloWorker extends Service<WorkerConfiguration> {
    ...
    public void initialize(Bootstrap<WorkerConfiguration> bootstrap) {
        ...
        bootstrap.addCommand(new ElasticSearchIndexerWorkerCommand("es_index_logs", "Indexes logs from Kinesis stream into elastic search index"));
