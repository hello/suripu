...
CREATE TABLE device_sensors_par_2014_08() INHERITS (device_sensors_master);
GRANT ALL PRIVILEGES ON device_sensors_par_2014_08 TO ingress_user;

CREATE UNIQUE INDEX uniq_device_ts_on_par_2014_08 on device_sensors_par_2014_08(device_id, ts);
CREATE UNIQUE INDEX uniq_device_id_account_id_ts_on_par_2014_08 on device_sensors_par_2014_08(device_id, account_id, ts);
...
DECLARE
	table_name text;
BEGIN
    IF NEW.local_utc_ts >= '2014-08-01 00:00:00' AND NEW.local_utc_ts < '2014-09-01 00:00:00' THEN
