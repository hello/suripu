...
CREATE TABLE device_sensors_par_2014_10() INHERITS (device_sensors_master);
GRANT ALL PRIVILEGES ON device_sensors_par_2014_10 TO ingress_user;

CREATE UNIQUE INDEX uniq_device_ts_on_par_2014_10 on device_sensors_par_2014_10(device_id, ts);
CREATE UNIQUE INDEX uniq_device_id_account_id_ts_on_par_2014_10 on device_sensors_par_2014_10(device_id, account_id, ts);



ALTER TABLE device_sensors_par_2014_10 ADD CHECK (local_utc_ts >= '2014-10-01 00:00:00' AND local_utc_ts < '2014-11-01 00:00:00');
