...
CREATE TABLE tracker_motion_par_2014_09() INHERITS (tracker_motion_master);
GRANT ALL PRIVILEGES ON tracker_motion_par_2014_09 TO ingress_user;

CREATE UNIQUE INDEX uniq_tracker_ts_on_par_2014_09 on tracker_motion_par_2014_09(tracker_id, ts);
CREATE UNIQUE INDEX uniq_tracker_id_account_id_ts_on_par_2014_09 on tracker_motion_par_2014_09(tracker_id, account_id, ts);



ALTER TABLE tracker_motion_par_2014_09 ADD CHECK (local_utc_ts >= '2014-09-01 00:00:00' AND local_utc_ts < '2014-10-01 00:00:00');
