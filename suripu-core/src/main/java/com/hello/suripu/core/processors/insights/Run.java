...
public class Run {
    public static Optional<InsightCard> getMarketingInsights(final Long accountId) {
        ...
        return Optional.of(new InsightCard(accountId, text.title, text.message, InsightCard.Category.RUN, InsightCard.TimePeriod.NONE, DateTime.now(DateTimeZone.UTC), categoryName));
    }
}
