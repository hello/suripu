...
*/
public class SleepSoundSettings2DynamoDB {
    private final static Logger LOGGER = LoggerFactory.getLogger(SleepSoundSettings2DynamoDB.class);
    ...
    private SleepSoundSettings2DynamoDB(final DynamoDB dynamoDB, final Table table) {
        this.dynamoDB = dynamoDB;
        this.table = table;
    }

    public static SleepSoundSettings2DynamoDB create(final AmazonDynamoDB amazonDynamoDB, final String tableName) {
        final DynamoDB dynamoDB = new DynamoDB(amazonDynamoDB);
        final Table table = dynamoDB.getTable(tableName);
        return new SleepSoundSettings2DynamoDB(dynamoDB, table);
    }
