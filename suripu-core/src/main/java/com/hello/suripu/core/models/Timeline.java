...
public class Timeline {
    ...
    public static Timeline create(@JsonProperty("score") final Integer score,
        ...
        return new Timeline(score, message, date, events, insights, sleepStats);
    }
    ...
    public static Timeline create(final Integer score,
        ...
        return new Timeline(score, message, date, events, insights, null);
    }


    public static Timeline createEmpty() {
        return new Timeline(0, English.TIMELINE_NO_SLEEP_DATA, "", Collections.EMPTY_LIST, Collections.EMPTY_LIST, null);
    }
