...
public interface FirmwareUpdateDAO {
    ...
    @SqlQuery("SELECT * FROM firmware_updates WHERE device_id = :device_id AND firmware_version > :current_firmware_version ORDER BY reset_application_processor ASC;")
