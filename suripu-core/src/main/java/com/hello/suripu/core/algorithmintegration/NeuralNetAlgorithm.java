...
public class NeuralNetAlgorithm implements TimelineAlgorithm {
    ...
    public static class NeuralNetAlgorithmOutput {
        public NeuralNetAlgorithmOutput(final double [][] output) {
            this.output = output;
        }
    ...
    public Optional<TimelineAlgorithmResult> getTimelinePrediction(final OneDaysSensorData oneDaysSensorData,final TimelineLog log,final long accountId,final boolean feedbackChanged) {
        ...
        try {
            ...
            final Optional<NeuralNetAlgorithmOutput> outputOptional = getNetOutputViaHttpPost(neuralNetServiceConfig.getSleepNetId(),x);
...
*/
    ...
    private Optional<NeuralNetAlgorithmOutput> getNetOutputViaHttpPost(final String netId,final double [][] sensorData) {
        ...
        try (final CloseableHttpClient httpclient = HttpClients.createDefault()) {
            final HttpPost httppost = new HttpPost(neuralNetServiceConfig.getEndpoint());
