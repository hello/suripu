...
public class Swim {
    public static Optional<InsightCard> getMarketingInsights(final Long accountId) {
        ...
        return Optional.of(new InsightCard(accountId, text.title, text.message, InsightCard.Category.SWIM, InsightCard.TimePeriod.NONE, DateTime.now(DateTimeZone.UTC), categoryName));
    }
}
