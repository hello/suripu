...
public class SmartAlarmLoggerDynamoDB {
    ...
    public static final String TIMEZONE_OFFSET_ATTRIBUTE_NAME = "offset_millis";
    ...
    public void log(final Long accountId, final DateTime lastSleepCycleEnd, final DateTime now,
        ...
        items.put(TIMEZONE_OFFSET_ATTRIBUTE_NAME, new AttributeValue().withN(offsetMillis.toString()));
