...
public class TimelineAlgorithmResult {
    ...
    public TimelineAlgorithmResult(final List<Event> events) {
        this(events,Collections.<Event>emptyList());
    }

    public TimelineAlgorithmResult(final List<Event> mainEvents, final List<Event> extraEvents) {
