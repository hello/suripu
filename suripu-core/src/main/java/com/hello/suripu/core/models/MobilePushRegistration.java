...
public class MobilePushRegistration {
     ...
     * @param endpoint
     */
    public MobilePushRegistration(final Long accountId, final String os, final String version, final String appVersion, final String deviceToken, final String endpoint) {
    ...
    public MobilePushRegistration(
        ...
        this(null, os, version, appVersion, deviceToken, null);
    }
    ...
    public static MobilePushRegistration withEndpointForAccount(final MobilePushRegistration m, final String endpoint, final Long accountId) {
        return new MobilePushRegistration(accountId, m.os, m.version, m.appVersion, m.deviceToken, endpoint);
    }
