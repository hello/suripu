...
import static com.hello.suripu.core.processors.QuestionSurveyProcessor.getSurveyOneQuestion;
...
//        questions.add(question6);
    ...
    public void testGetSurveyOneQuestion0() {
        ...
        final List<Question> questionServed = getSurveyOneQuestion(surveyOneResponses, SurveyOneQuestions);
    ...
    private QuestionSurveyProcessor setUp() {
        ...
        final ImmutableList<Question> mockSurveyOneQuestions = getMockQuestions();
        Mockito.when(mockQuestionResponseReadDAO.getAllQuestions()).thenReturn(mockSurveyOneQuestions);
