...
import com.hello.suripu.core.db.sleep_sounds.SleepSoundSettings2DynamoDB;
...
public class SleepSoundSettings2DynamoDBIT {
    private final static Logger LOGGER = LoggerFactory.getLogger(SleepSoundSettings2DynamoDBIT.class);

    private AmazonDynamoDBClient amazonDynamoDBClient;
    private SleepSoundSettings2DynamoDB dao;
    ...
    public void setUp(){
        ...
        try {
            ...
            SleepSoundSettings2DynamoDB.createTable(this.amazonDynamoDBClient, tableName);
            LOGGER.debug("Created dynamoDB table");
            this.dao = SleepSoundSettings2DynamoDB.create(this.amazonDynamoDBClient, tableName);
