...
//        System.out.print(card.get().message);
    ...
    public void test_sleepAlarmProcessor() throws IOException {
        ...
        //Fake accountReadDAO
        final AccountReadDAO accountReadDAO = mock(AccountDAO.class);
        ...
        final AccountPreferencesDAO accountPreferencesDAO = mock(AccountPreferencesDAO.class);

        final SleepAlarm sleepAlarm = SleepAlarm.create(sleepStatsDAODynamoDB, accountReadDAO, null);
        InsightProfile insightProfile = new InsightProfile(null, null,null, null, null);
        final Optional<InsightCard> generatedCard = sleepAlarm.generate(insightProfile);
